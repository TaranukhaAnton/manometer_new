...
<%--<%= request.getParameter("type") %>--%>
    <table class="options">
        ...
        <%  Integer type = new Integer( request.getParameter("type"));
            ...
            String[][] lab =   {
                                {"42", "24", "&#8730 42", "05", "50", "&#8730 05", "ДУ 50", "ДУ 80", "H1", "H2", "H3", "H4", "H5", "H6", "H7", "H8", "H9", "H10", "H11", "H12", "H13", "H14", "H15", "H16", "H17", "H18", "H19", "H20", "H21", "H31", "H32", "H33", "H34", "H35", "H36", "H37", "H38", "H39", "H40", "H41", "H42", "-И", "-ПИ", "ВМ", "-Хим", /*"-P",*/"-P ##","-PГ ##","-PТ ##","-PD ##", "-PK", "-PD", "госповерка"},
                                {"42", "24", "&#8730 42", "05", "50", "&#8730 05", "ДУ 50", "ДУ 80", "H1", "H2", "H3", "H4", "H5", "H6", "H7", "H8", "H9", "H10", "H11", "H12", "H13", "H14", "H15", "H16", "H17", "H18", "H19", "H20", "H21", "H31", "H32", "H33", "H34", "H35", "H36", "H37", "H38", "H39", "H40", "H41", "H42", "-И", "-ПИ", "ВМ", "-Хим", /*"-P",*/"-P ##","-PГ ##","-PТ ##","-PD ##", "-PK", "-PD", "госповерка"},
                                {"42", "24", "&#8730 42", "05", "50", "&#8730 05", "ДУ 50", "ДУ 80", "-И", "-ПИ", "ВМ", "-Хим",  "-PK", "-PD", "госповерка"},
                                {"42", "24", "&#8730 42", "05", "50", "&#8730 05", "ДУ 50", "ДУ 80", "H1", "H2", "H3", "H4", "H5", "H6", "H7", "H8", "H9", "H10", "H11", "H12", "H13", "H14", "H15", "H16", "H17", "H18", "H19", "H20", "H21", "H31", "H32", "H33", "H34", "H35", "H36", "H37", "H38", "H39", "H40", "H41", "H42", "-И", "-ПИ", "ВМ", "-Хим", /*"-P",*/"-P ##","-PГ ##","-PТ ##","-PD ##", "-PK", "-PD", "госповерка"}};
