...
<display:table name="userList"
    ...
    <display:column property="lastName" title="Фамилия" sortable="true" maxLength="11" class="col2"/>
    ...
    <display:column property="receptionOnWorkDate" title="Дата пр." format="{0,date,dd.MM.yyyy}" class="col6"/>
    <display:column property="dischargingDate" title="Дата ув." format="{0,date,dd.MM.yyyy}" class="col7"/>
    ...
    <display:column title="" url="/users/delete"   paramId="user_id" paramProperty="id" class="col12">
